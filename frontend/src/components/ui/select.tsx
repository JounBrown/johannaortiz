  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "flex w-full min-w-0 items-center justify-between gap-2 rounded-lg border-2 bg-white px-4 py-3 text-base transition-all duration-200 outline-none",
        ...
        // Hover states matching Input
        "hover:border-slate-400",
        // Dark mode matching Input
        ...
        "dark:data-[placeholder]:text-slate-400",
        // Disabled states
        "disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50",
        // Error/validation states matching Input
